...
- Download and install the source version of [CMU Sphinx4](http://sourceforge.net/projects/cmusphinx/files/sphinx4/1.0%20beta6/sphinx4-1.0beta6-src.zip/download) to $SPHINX_INSTALL_DIRECTORY. Instruction can be found in this [website](http://cmusphinx.sourceforge.net/wiki/sphinx4:howtobuildand_run_sphinx4).
...
- Change original config.xml from src/apps/edu/cmu/sphinx/demo/transcriber/config.xml to **** to be completed ***
