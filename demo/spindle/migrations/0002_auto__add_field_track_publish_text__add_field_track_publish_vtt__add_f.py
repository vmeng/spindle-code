...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Track.publish_text'
        db.add_column('spindle_track', 'publish_text',
                      self.gf('django.db.models.fields.CharField')(default='hidden', max_length=6),
                      keep_default=False)

        # Adding field 'Track.publish_vtt'
        db.add_column('spindle_track', 'publish_vtt',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=6),
                      keep_default=False)

        # Adding field 'Track.publish_transcript'
        db.add_column('spindle_track', 'publish_transcript',
                      self.gf('django.db.models.fields.CharField')(default='no', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Track.publish_text'
        db.delete_column('spindle_track', 'publish_text')

        # Deleting field 'Track.publish_vtt'
        db.delete_column('spindle_track', 'publish_vtt')

        # Deleting field 'Track.publish_transcript'
        db.delete_column('spindle_track', 'publish_transcript')
