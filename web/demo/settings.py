...
INSTALLED_APPS = (
    ...
    # Spindle
    "spindle",
    # Spindle submodules which need to be here for Celery to load
...
# Monitors iTunes U scanning settings.
# Whether to wait a random interval (of seconds) before doing HTTP requests or not.
WAIT_GET = False
# Name as displayed on the iTunes U organisation listings
YOUR_INSTITUTION = "Oxford University"

# Django Celery task queue support, used by Spindle
import djcelery
