...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Track.keyword_cache_time'
        db.add_column('spindle_track', 'keyword_cache_time',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Track.keyword_cache_time'
        db.delete_column('spindle_track', 'keyword_cache_time')
    ...
    models = {
        ...
        'spindle.track': {
            ...
            'keyword_cache_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
